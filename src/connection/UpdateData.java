...
public class UpdateData {
    ...
    public static boolean updateSanBay(SanBay sanBay) {
        String sqlCommand = "update SANBAY set TenSanBay=? , DiaDiem=?"
                + " where MaSanBay=?";
        try {
    ...
    public static boolean updateMayBay(MayBay mayBay) {
        String sqlCommand = "update MAYBAY set HANGBAY=?, SOGHE=?"
                + " where SHMB=?";
        try {
            DataConnection.createStatement();
            PreparedStatement ps = DataConnection.connection.prepareStatement(sqlCommand);
    ...
    public static boolean updateDuongBay(DuongBay duongbay) {
        String sqlCommand = "update DUONGBAY set  khoangcach=? " + " where MaDuongBay=?";
    ...
    public static boolean updateKhachHang(KhachHang kh) {
        String sqlCommand = "update KhachHang set  HOVATEN=? , ngaysinh = ?, email=?" + " where sdt=?";
